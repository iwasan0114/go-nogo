                ...
                <section>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                        <ul className="list-disc list-inside space-y-2">
                            <li><strong>Go試行：</strong>特定の刺激（例：青色の円）が表示されたら、できるだけ早くボタンを押してください</li>
                            <li><strong>NoGo試行：</strong>別の刺激（例：赤色の円）が表示されたら、ボタンを押さずに我慢してください</li>
                            <li>各刺激は短時間（通常1-2秒）表示されます</li>
                            <li>反応時間と正確性の両方が記録されます</li>
                        </ul>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                        <ul className="list-disc list-inside space-y-1 text-sm">
                            ...
                            <li>練習試行で操作に慣れてから本試行を開始してください</li>
                        </ul>
                    </div>
                </section>
            </div>
